...
contract SimpleTimelock {
    ...
    constructor() {
        ...
        lpToken = IERC20(0xB8e49bA4dB86fd340A6fd8B8E6Fc7C42C03e4E10);
        lpTokenAddress =0xB8e49bA4dB86fd340A6fd8B8E6Fc7C42C03e4E10;
    ...
    modifier onlyDepositor() {
        require(depositors[msg.sender] == true, "Message sender must be the contract's owner.");
        _;
    }

    function configureDepositor(address _depositor, bool enabled) public onlyOwner{
        depositors[msg.sender] = enabled;
    }
