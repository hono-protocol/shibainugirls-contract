...
contract Bond is IBond{
    ...
    constructor() {
        ...
        owner = payable(msg.sender);
        lpToken = IBEP20(0x93DD0aDa344CCB6a22EeCf7D4B278b3643c68BDa);
        lpTokenAddress =0x93DD0aDa344CCB6a22EeCf7D4B278b3643c68BDa;
    ...
    {
        uint256 tokenAmount = availableToken - lowerCap; 
        return lpToken.totalSupply().mul(tokenAmount).div(bep20Token.balanceOf(lpTokenAddress)).div(2).div(profit).mul(profitDenominator);
    }
